...
def rot():
    ...
    global l,l1
    global int_blur,int_rot,int_bright,x,x1,x2
    x=0
    x1=0
    x2=0
    int_rot=1
...
def blur():
    global image
    global int_blur,int_rot,int_bright,x1,x2
    int_blur=1
...
def brit():
    global image
    global int_blur, int_rot, int_bright
    int_bright = 1
    global bluradd, blurneg
    global rot_n_c, rot_n_cc, rot_e, flip_y, flip_x, flip_xy
    global briadd, brineg
